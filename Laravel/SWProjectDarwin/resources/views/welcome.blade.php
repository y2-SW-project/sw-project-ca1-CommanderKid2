...
<body>
    {{-- <a href="/login"> Login</a>
        ...
        <a href="/register"> About</a> --}}
          ...
          {{-- <-----> NAV 1 --}}
    <nav class=" navbar-expand-lg navbar-dark bg-dark shadow-lg ">

        <ul class="nav justify-content-end">
            <li class="nav-item">
                <a class="nav-link active text-white" aria-current="page" href="#">Welcome to AceFly</a>
            </li>
            <li class="nav-item ">
            ...
            <li class="nav-item ">
                <a class="nav-link text-white" href="#">Login | Register</a>
            </li>
        </ul>
    </nav>
        ...
        <div class="container ">
            <div class="row align-items-center my-5">
                <div class="col-md-5">
                    ...
                    <img src={{ URL::to('/storage/imgs/2.svg') }} width="500" height="500">


                </div>
                <div class="col-md-6 text-center text-md-start">
                    <p class="display-6 text-danger">New Arrivals</p>
                    <p class="display-6 text-dark">With AceFly you get components and examples, <br>including tons
                        of
                        variables that will help you <br> customizet this drone.</p>
                    <br>
                    <h3><span class="text-white btn btn-dark rounded-3">Purschase now</span></h3>
                </div>
            </div>
        </div>
